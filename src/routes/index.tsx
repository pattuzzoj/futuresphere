...
import hero from "assets/images/home_hero.webp";
  ...
  return (
    <>
      ...
      <Section>
        ...
        <img class="self-center rounded-full" src={hero} alt="" fetchpriority="high"/>
      ...
      <Section>
        ...
        <div class="flex flex-wrap justify-center gap-4 mt-1.5">
          <span class="flex items-center text-3xl dark:text-white font-bold gap-0.5">
            <img class="size-4" src="/assets/icons/clients/discord.svg" alt="" loading='lazy'/>
            Discord
          </span>
          <span class="flex items-center text-3xl dark:text-white font-bold gap-0.5">
            <img class="size-4" src="/assets/icons/clients/shopify.svg" alt="" loading='lazy'/>
            Shopify
          </span>
          <span class="flex items-center text-3xl dark:text-white font-bold gap-0.5">
            <img class="size-4" src="/assets/icons/clients/slack.svg" alt="" loading='lazy'/>
            Slack
          </span>
          <span class="flex items-center text-3xl dark:text-white font-bold gap-0.5">
            <img class="size-4" src="/assets/icons/clients/google.svg" alt="" loading='lazy'/>
            Google
          </span>
        </div>
      </Section>
      <Section>
        <Slide type="item" control="buttons" position="start">
          <div class="grid md:grid-cols-2 gap-1.5 text-start">
            ...
            <img class="size-100 md:h-24 rounded-3xl object-cover" src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8dGVhbXxlbnwwfHwwfHx8MA%3D%3D" alt="" loading='lazy'/>
          </div>
          <div class="grid md:grid-cols-2 gap-1.5 text-start">
            <div class="flex flex-col justify-center gap-1 text-start">
              <span class="text-purple">{t("services.section")}</span>
            ...
            <img class="size-100 md:h-24 rounded-3xl object-cover" src="https://plus.unsplash.com/premium_photo-1661414415246-3e502e2fb241?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8bWFya2V0aW5nfGVufDB8fDB8fHww" alt="" loading='lazy'/>
          </div>
          <div class="grid md:grid-cols-2 gap-1.5 text-start">
            <div class="flex flex-col justify-center gap-1 text-start">
              <span class="text-purple">{t("services.section")}</span>
            ...
            <img class="size-100 md:h-24 rounded-3xl object-cover" src="https://images.unsplash.com/photo-1587440871875-191322ee64b0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvY2Vzc3xlbnwwfHwwfHx8MA%3D%3D" alt="" loading='lazy'/>
          </div>
        </Slide>
      </Section>
      <Section>
        ...
        <Slide type="item" control="buttons" position="end">
          <div class="grid md:grid-cols-2 gap-1.5 text-start">
            <img class="size-100 md:h-24 rounded-3xl object-cover" src="https://images.unsplash.com/photo-1474176857210-7287d38d27c6?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" loading='lazy'/>
          ...
          <div class="grid md:grid-cols-2 gap-1.5 text-start">
            <img class="size-100 md:h-24 rounded-3xl object-cover" src="https://images.unsplash.com/photo-1609837644611-47e1d1841299?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxjb2xsZWN0aW9uLXBhZ2V8MXxrbDJaRml3WWpJc3x8ZW58MHx8fHx8" alt="" loading='lazy'/>
            <div class="flex flex-col justify-between gap-1 text-start">
          ...
          <div class="grid md:grid-cols-2 gap-1.5 text-start">
            <img class="size-100 md:h-24 rounded-3xl object-cover" src="https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxjb2xsZWN0aW9uLXBhZ2V8NHwxNzI0Mzc2fHxlbnwwfHx8fHw%3D" alt="" loading='lazy'/>
            <div class="flex flex-col justify-between gap-1 text-start">
