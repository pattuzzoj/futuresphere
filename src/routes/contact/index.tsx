            ...
            <div>
              <Form class="flex-grow flex flex-col gap-2.5" onSubmit={() => {}}>
                ...
                >
                  {(field, props) => (
                    <div class="relative">
                      <textarea {...props} class="w-100 outline-none border-2 rounded-lg text-black focus:border-purple border-gray-400 p-0.5 placeholder-transparent caret-purple peer" text-blackows="5" placeholder={t("form.message.text")} required/>
                ...
                <div class="flex flex-col justify-between items-start gap-2 lg:flex-row lg:items-center">
                  <Field 
                  name="terms"
                  type="boolean"
                  validate={[
