  ...
  return (
    <footer class="bg-gradient-to-r from-purple-500 via-purple-400 to-purple-500 p-1 text-white md:p-1.5">
      ...
      <div class="my-1 mb-1 flex flex-col items-center sm:flex-row sm:justify-between">
        <a class="flex h-1.75" href="/"><img src="/assets/icons/logo.svg" alt="" loading="lazy"/> FutureSphere</a>
      ...
      <div class="mt-1 flex justify-center sm:items-center sm:justify-between">
        ...
        <nav aria-label="Social Media" class="hidden gap-1 sm:flex">
          <a class="hover:bg-dark cursor-pointer rounded-full p-0.5 flex items-center justify-center" href="" aria-label="Follow on Twitter">
            <Icon
              color="fill-white"
              name="BsTwitter"
            />
          </a>
          <a class="hover:bg-dark cursor-pointer rounded-full p-0.5 flex items-center justify-center" href="" aria-label="Follow on Facebook">
            <Icon
              color="fill-white"
              name="BsFacebook"
            />
          </a>
          <a class="hover:bg-dark cursor-pointer rounded-full p-0.5 flex items-center justify-center" href="" aria-label="Follow on Linkedin">
            <Icon
              color="fill-white"
              name="BsLinkedin"
            />
